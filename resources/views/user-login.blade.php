    ...
    <div class="flex-1 flex items-center justify-center px-4 py-12">
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md p-10 border border-purple-50">
            ...
            <div class="text-center mb-8">
                ...
                <h3 class="text-2xl font-extrabold text-gray-800">Welcome Back</h3>
                <p class="text-gray-400 text-sm mt-1">Login to continue your quiz journey</p>
            </div>
            ...
            <form action="/user_login" method="post" class="space-y-5">
                @csrf
                <div>
                ...
                <div class="flex justify-between text-xs text-gray-400 pt-1">
                    <a href="/forget-password" class="grad-text font-semibold hover:opacity-80">Forgot password?</a>
                    <a href="/user_signup" class="grad-text font-semibold hover:opacity-80">Create account</a>
                </div>
            </form>
        </div>
    </div>
