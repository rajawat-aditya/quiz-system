    ...
    <div class="flex-1 flex items-center justify-center px-4 py-12">
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md p-10 border border-purple-50">
            ...
            <div class="text-center mb-8">
                ...
                <h3 class="text-2xl font-extrabold text-gray-800">Create Account</h3>
                <p class="text-gray-400 text-sm mt-1">Join and start testing your skills</p>
            </div>
            ...
            <form action="user_signup" method="post" class="space-y-4">
                @csrf
                <div>
                ...
                <button class="grad-btn w-full py-3 text-white font-bold rounded-xl transition text-sm shadow-lg mt-2">
                    Sign Up →
                </button>

                <p class="text-center text-xs text-gray-400 pt-1">
                    Already have an account? <a href="/user_login" class="grad-text font-semibold hover:opacity-80">Login</a>
                </p>
            </form>
        </div>
    </div>
