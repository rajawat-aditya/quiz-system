    ...
    <div class="flex-1 flex items-center justify-center px-4 py-12">
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md p-10 border border-purple-50">
            ...
            <div class="text-center mb-8">
                ...
                <h3 class="text-2xl font-extrabold text-gray-800">Set New Password</h3>
                <p class="text-gray-400 text-sm mt-1">Choose a strong new password</p>
            </div>
            ...
            <form action="/set-forget-password" method="post" class="space-y-5">
                @csrf
                <input type="hidden" name="email" value="{{ $email }}">
                <div>
                    <label class="block text-sm font-semibold text-gray-600 mb-1.5">New Password</label>
