...
<body class="bg-slate-50 flex flex-col min-h-screen">
    ...
    <!-- Header -->
    <div style="background:linear-gradient(135deg,#6366f1 0%,#8b5cf6 40%,#ec4899 100%);" class="text-white py-12 px-6 text-center relative">
        <a href="/show-category" class="absolute left-5 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 text-white text-sm font-semibold px-4 py-2 rounded-xl transition backdrop-blur">
            ← Back
        </a>
        <h1 class="text-4xl font-extrabold mb-2">📋 Quizzes</h1>
        <p class="text-indigo-100 text-sm">Category: <span class="font-bold text-yellow-300">{{ $categories }}</span></p>
    </div>
